...
Почти любой тип может стать монадой! Главное сказать компилятору как с этим типом использовать три основные монадические операции, а именно
